package com.yingda.lkj.utils.position;
...
public class CoordinateTransform {
     ...
     * 即 百度 转 谷歌、高德
     */
    public static double[] baiduToGoogle(double bd_lon, double bd_lat) {
     ...
     * 即谷歌、高德 转 百度
     */
    public static double[] googleToBaidu(double gcj_lon, double gcj_lat) {
    ...
    public static double[] bd09towgs84(double bd_lon, double bd_lat) {
        //1、bd09->gcj
        double[] bd09_gcj02 = baiduToGoogle(bd_lon, bd_lat);
        //2、gcj->wgs84
     ...
     * wgs84z转换为百度坐标
     */
    public static double[] gpsToBaidu(double wgs_lon, double wgs_lat) {
        //1、wgs84->gcj
        double[] wgs84_gcj02 = wgs84togcj02(wgs_lon, wgs_lat);
        //2、gcj->bd09
        return googleToBaidu(wgs84_gcj02[0], wgs84_gcj02[1]);
    }
